# ProyectoBar
Aplicación del punto de venta de un bar como proyecto final del módulo Desarrollo de Interfaces del grado superior de Desarrollo de Aplicaciones Multiplataforma.
